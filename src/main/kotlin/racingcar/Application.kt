...
const val NOT_INT_OR_NULL = "숫자가 아니거나 null입니다."
const val INPUT_UNDER_ZERO = "입력 값에 음수가 있습니다."
const val INPUT_OVER_FIVE_OR_NULL = "이름이 5자가 넘어가거나 값이 없습니다."
const val INPUT_HAVE_SPACE = ",뒤에 공백이 있습니다."
const val INPUT_DUPLICATE = "중복된 수가 있습니다."
const val INPUT_SIZE = "2대 이상 입력해야 합니다."
const val SPACE = " "
